...
SHORTLINK_API = environ.get('SHORTLINK_API', 'be363fc95f1e53c0d58ed98430fc5cc3eb767ae1')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "10")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/wibimovie')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+lTZqqHOsqPA2N2E1')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Download_From_Wibi_Movies/15')
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'Welcome 🙏')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', ''))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'moviemasalas_support')
