...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('SUPPORT', url="https://t.me/moviemasalas_support"), 
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if is_valid == True:
            await message.reply_text(
                text=f"<b>Hey {message.from_user.mention}, You are successfully verified !\nNow you have unlimited access for all movies till today./n/n Request your file again.</b>",
                protect_content=True
            )
...
async def shortlink(bot, message):
    ...
    chat_type = message.chat.type
    if chat_type == enums.ChatType.PRIVATE:
        return await message.reply_text(f"<b>Hey {message.from_user.mention}, This command only works on groups !\n\n<u>Follow These Steps to Connect Shortener:</u>\n\n1. Add Me in Your Group with Full Admin Rights\n\n2. After Adding in Grp, Set your Shortener\n\nSend this command in your group\n\n—> /shortlink ""{your_shortener_website_name} {your_shortener_api}\n\n#Sample:-\n/shortlink vnshortener.com be363fc95f1e53c0d58ed98430fc5cc3eb767ae1\n\nThat's it!!! Enjoy Earning Money 💲\n\n[[ Trusted Earning Site : https://vnshortener.com ]]\n\nIf you have any Doubts, Feel Free to Ask me - @MalsalaAdmin\n\n@MalsalaAdmin</b>")
    elif chat_type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete :(\n\nGive me a shortener website link and api along with the command !\n\nFormat: <code>/shortlink vnshortener.com be363fc95f1e53c0d58ed98430fc5cc3eb767ae1</code></b>")
